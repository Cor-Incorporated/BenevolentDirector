"""Pub/Sub subscriber for estimate request events."""
...
EstimateRequestedHandler = Callable[[dict[str, Any]], None]


class EstimateRequestedSubscriber:
    """Subscribe to estimate request events and dispatch handler."""

    TARGET_EVENT_NAMES = {"estimate.requested", "EstimateRequested"}
    ...
    def __init__(
        ...
        *,
        ...
        project_id: str,
        subscription_id: str,
        handler: EstimateRequestedHandler,
    ) -> None:
        self._client = client
